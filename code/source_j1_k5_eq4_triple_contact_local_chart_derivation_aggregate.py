...
keys=['classification','target_triangle','required_fields','missing_fields','common_coordinates_present','three_contact_maps_present','contact_differential_rank','jacobian_normalization_transport_present','s3_coordinate_transport_present','controls','source_facts','claim_ceiling']
