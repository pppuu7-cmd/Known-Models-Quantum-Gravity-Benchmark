...
keys = [
    'classification', 'exact_run', 'terminal_c4_retained', 'latest_critic_repaired',
    'authority_identity', 'artifact_internal_file_sha256', 'assembly_byte_identical',
    'lanes', 'aggregate_observed', 'critic_observed', 'repair_verdict_observed',
    'semantics_controls', 'semantics_controls_all_pass', 'review_errors', 'science',
    'claim_ceiling'
]
