...
out={'iteration':473,'classification':classification,'audit_completed':True,'tracked_python_files':len(code_files),'qualified_candidates':qualified,'top_candidates':rows[:25],'scope':'tracked-repository executable availability only; BLOCKED is not impossibility or literature absence; no convergence/divergence inference','d7_s2':'NOT_CLOSED'}
