...
GATE='ITER504T_LOCAL_DERIVATIVE_ENCLOSURE_CONTRACTION';PREREG='aa2b0256ce60d605574a18ec86c0bad5b5df1512';INVALID='ITER504T_INVALID'
...
def main():
 ...
 out={'gate':GATE,'preregistration_commit':PREREG,'classification':cls,'errors':errs,'lane_a_sha256':Ah,'lane_b_sha256':Bh,'cross_environment_exact_decision_agreement':cross,'threshold_exact':'1/20','robust_floor_exact':'1','partition_identity_verified':'exact_rational_dyadic_cells','total_unresolved_leaves':A.get('total_unresolved_leaves') if not errs else None,'total_terminal_leaves':A.get('total_terminal_leaves') if not errs else None,'total_visited_nodes':A.get('total_visited_nodes') if not errs else None,'claim_ceiling':'Cross-environment Iter504T decision aggregate only'}
