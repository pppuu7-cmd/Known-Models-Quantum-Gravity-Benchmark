...
def main() -> None:
    ...
    lane_decision_agree = a.get("review_decision_sha256") == b.get("review_decision_sha256")
    boundary_control_ok = (
    ...
    simulated = next((e for e in control_entries if e.get("role") == simulated_role), None)
    ...
    aggregate_controls = {
        ...
        "lane_decision_sha256_agreement": lane_decision_agree,
    ...
    out = {
        ...
        "lanes_agree": lane_class_agree and lane_decision_agree,
        "aggregate_controls": aggregate_controls,
        "aggregate_controls_all_pass": controls_ok,
        "lane_a_decision_sha256": a.get("review_decision_sha256"),
        "lane_b_decision_sha256": b.get("review_decision_sha256"),
        "lane_a": a,
        "lane_b": b,
    ...
    out["aggregate_decision_sha256"] = hashlib.sha256(canonical.encode()).hexdigest()
