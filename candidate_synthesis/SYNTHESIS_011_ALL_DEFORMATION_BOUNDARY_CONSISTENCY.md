# SYNTHESIS-011 — All-Deformation Boundary Consistency Parent
...
The next candidate should test a prospective gravity-native rule for the allowed asymptotic growth class itself. A viable rule must
